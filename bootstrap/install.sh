...
# step_disable_display_manager   # disabled: greetd + nwg-hello is now the
# desired login manager (see ~/.config/greetd/). Was: self-skips on Mint; only
# disables the DM on Arch.
step_restore_home
